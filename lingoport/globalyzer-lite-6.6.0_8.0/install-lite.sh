...
#
sed -i'.bak' -e "s|\${user.home}|$newHome|g" "${script_location}/log4j.properties"
rm -f ${script_location}/log4j.properties.bak

if grep -q "\${user.home}" ${script_location}/log4j.properties ; then
