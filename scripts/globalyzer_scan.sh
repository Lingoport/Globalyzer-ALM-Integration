...
chmod +x ${GLOBALYZER_HOME}/lingoport/globalyzer-lite-6.7.0_9.0/install-lite.sh
...
echo "=================================================="
echo ""
bash ${GLOBALYZER_HOME}/lingoport/globalyzer-lite-6.7.0_9.0/install-lite.sh
...
echo "=================================================="
echo ""
java -jar ${GLOBALYZER_HOME}/lingoport/globalyzer-lite-6.7.0_9.0/globalyzer-lite.jar $LITE_DEFINITION_FILE_PATH
